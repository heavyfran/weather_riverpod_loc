...
/// @nodoc
abstract class _$$_DirectGeocodingCopyWith<$Res>
    implements $DirectGeocodingCopyWith<$Res> {
  factory _$$_DirectGeocodingCopyWith(
          _$_DirectGeocoding value, $Res Function(_$_DirectGeocoding) then) =
      __$$_DirectGeocodingCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({String name, double lat, double lon, String country});
}
...
/// @nodoc
class __$$_DirectGeocodingCopyWithImpl<$Res>
    extends _$DirectGeocodingCopyWithImpl<$Res, _$_DirectGeocoding>
    implements _$$_DirectGeocodingCopyWith<$Res> {
  __$$_DirectGeocodingCopyWithImpl(
      _$_DirectGeocoding _value, $Res Function(_$_DirectGeocoding) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$_DirectGeocoding(
      name: null == name
          ? _value.name
          : name // ignore: cast_nullable_to_non_nullable
              as String,
...
/// @nodoc
@JsonSerializable()
class _$_DirectGeocoding
    with DiagnosticableTreeMixin
    implements _DirectGeocoding {
  const _$_DirectGeocoding(
      {this.name = '', this.lat = 0.0, this.lon = 0.0, this.country = ''});

  factory _$_DirectGeocoding.fromJson(Map<String, dynamic> json) =>
      _$$_DirectGeocodingFromJson(json);
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$_DirectGeocodingCopyWith<_$_DirectGeocoding> get copyWith =>
      __$$_DirectGeocodingCopyWithImpl<_$_DirectGeocoding>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_DirectGeocodingToJson(
      this,
    );
  }
}
...
abstract class _DirectGeocoding implements DirectGeocoding {
  const factory _DirectGeocoding(
      ...
      final double lat,
      final double lon,
      final String country}) = _$_DirectGeocoding;

  factory _DirectGeocoding.fromJson(Map<String, dynamic> json) =
      _$_DirectGeocoding.fromJson;
